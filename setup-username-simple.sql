-- Script SQL simplificado paso a paso
-- Ejecuta cada bloque por separado si tienes problemas
...
-- PASO 3: Crear índice para username (solo después de agregar datos)
-- Este paso se ejecutará después del PASO 4

-- PASO 4: Actualizar usuario con username fijo y nueva contraseña
UPDATE admin_users 
SET 
    username = 'eduardo',
...
-- PASO 5: Crear índice para username (ahora que tenemos datos)
CREATE INDEX IF NOT EXISTS idx_admin_users_username ON admin_users(username);

-- PASO 6: Recrear función de verificación
